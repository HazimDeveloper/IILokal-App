                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Laptop</h4>
                            </div>
							<br>
    ...
    <div class="container">
        ...
        <form method="POST" action="">
			...
			$sql = "SELECT * FROM `laptop`  
				WHERE serial_no  = '$data_search'";
			$query = mysqli_query($db,"SELECT * FROM `laptop` WHERE serial_no = '$data_search' or problem like '%$data_search%' or warranty_current_date like '%$data_search%' "); 
			Header('location: all_menu.php');
}						
else { 
					$sql="SELECT * FROM laptop order by serial_no desc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$rows['current_warrant_date'].'</td>
																					<td>'.$rows['problem'].'</td>
																					
																								<td>'.$rows['serial_no'].'</td>
																								<td>'.$rows['laptop_desc'].'</td>
																								...
																								<center><img src="Res_img/'.$rows['image'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																									 ...
																									 <td><a href="delete_menu.php?menu_del='.$rows['laptop_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_menu.php?menu_upd='.$rows['laptop_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
